...
class FilesController {
  ...
  static async getShow(req, res) {
    ...
    // Retrieve file document linked to the user
  ...
  // Get all files for a specific parentId with pagination
  static async getIndex(req, res) {
    ...
    // Retrieve files for the user based on parentId
    const files = await FileModel.find({ userId: user._id, parentId })
      .limit(limit)
      .skip(skip);
